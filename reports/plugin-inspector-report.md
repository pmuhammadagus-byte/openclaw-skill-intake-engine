...
| ---------------------------- | -------- | ------------ | ----- | ------------- | ------------------ |
| openclaw-skill-intake-engine | high     | dynamic-tool | -     | -             | tools              |
...
| ---------------------------- | ----------------------- | ----- | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------- |
| openclaw-skill-intake-engine | seam-inventory          | log   | observed 0 hooks, 0 registrations, and 1 manifest contracts                           | manifestContract:tools                                                        | -             |
| openclaw-skill-intake-engine | hook-names-present      | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                                             | -             |
| openclaw-skill-intake-engine | api-registrars-present  | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | -                                                                             | -             |
| openclaw-skill-intake-engine | sdk-exports-present     | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/tool-plugin                                               | -             |
| openclaw-skill-intake-engine | manifest-fields-checked | log   | plugin manifest fields were compared with target OpenClaw manifest types              | openclaw.plugin.json                                                          | -             |
| openclaw-skill-intake-engine | package-metadata        | log   | selected package metadata for plugin contract checks                                  | package.json, @pmuhammadagus-byte/openclaw-skill-intake-engine, version:0.1.0 | -             |
| openclaw-skill-intake-engine | declarative-contracts   | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                         | -             |
